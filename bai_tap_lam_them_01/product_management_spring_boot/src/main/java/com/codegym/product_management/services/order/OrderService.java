...
public class OrderService implements IOrderService {
    ...
    @Override
    public List<Order> findAllBy(String name, Double fromPrice, Double toPrice, String fromOrderDate, String toOrderDate) {
        return orderRepository.findAllBy(name, fromPrice, toPrice, fromOrderDate, toOrderDate);
    }
