...
public class Product {
    ...
    public Product(String name, String manufacture, String productionDate, String price, Category category, ProductDetail productDetail) {
        this.name = name;
    ...
    public Product(String name, String manufacture, String productionDate, String price, Category category, ProductDetail productDetail, List<Order> orders) {
        this.name = name;
        this.manufacture = manufacture;
        this.productionDate = productionDate;
        this.category = category;
